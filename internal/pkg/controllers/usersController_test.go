...
var testsSignUp = []TestCases{
	...
	},
	{
		...
		method:         "POST",
		url:            "/api/user",
		body:           strings.NewReader(`{"login": "kekkekkek1", "email": "kek@email1.kek","password": "password", "avatar_link":"/001-default-avatar.png"}`),
		urlValues:      "",
		expectedRes:    ``,
		expectedStatus: http.StatusOK,
		authCtx:        false,
	},
	{
		...
		method:         "POST",
		url:            "/api/user",
		body:           strings.NewReader(`{"login": "kekkekkek123", "email": "kek@email1.kek","password": "password", "avatar_link":"/001-default-avatar.png"}`),
		urlValues:      "",
